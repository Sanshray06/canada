...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute float-shape"
      ...
      <div
        className="absolute float-shape-delay"
        style={{ bottom: "25%", right: "20%", opacity: 0.08 }}
      >
        <div
          className="w-24 h-24 rounded-full border-2"
          style={{ borderColor: "#1E6FFF" }}
        />
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 pt-24 pb-32">
        <div className="max-w-3xl">
          ...
          >
            Professional airport transfers, corporate transportation,
            long-distance travel, and chauffeur services available
            24/7. Travel comfortably, safely, and on time with our
          ...
          {/* Trust bar */}
          <div
            className="flex flex-wrap gap-6 mt-12 pt-10"
